...
# desafio 033 
# Faça um programa que leia três números e mostre qual é o maior a qual é o menor.

# desafio 034 
# Escreva um programa que pergunte o salário de um Funcionário z calcule o valor do seu aumento.
